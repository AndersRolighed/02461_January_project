...
SAVEPATH = "model_hpc_focal-batch2-0001-300.pth.tar"
LOSS_PATH = "loss_array_focal-batch2-0001-300.npy"
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if epoch == 100:
            torch.save({
                ...
                }, "model_hpc_focal-batch2-0001-100.pth.tar")
        ...
        if epoch == 200:
            torch.save({
                ...
                'total_loss': total_loss,
                'loss_pr_epoch': loss_pr_epoch
                }, "model_hpc_focal-batch2-0001-200.pth.tar")
